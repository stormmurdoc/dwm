...
static Key keys[] = {
    ...
    {MODKEY, XK_F1, spawn,
     SHCMD("pamixer -t; kill -44 $(pidof dwmblocks) && pa_notify.sh")},
    {MODKEY | ShiftMask, XK_F1, spawn, SHCMD("fcmd.sh az arbeiten")},
    {MODKEY, XK_F2, spawn, SHCMD("dmenuunicode")},
    {MODKEY | ShiftMask, XK_F2, spawn, SHCMD("fcmd.sh az spielen")},
    {MODKEY, XK_F3, spawn, SHCMD("st -e displayselect.sh")},
    {MODKEY | ShiftMask, XK_F3, spawn, SHCMD("fcmd.sh az hell")},
    {MODKEY, XK_F4, spawn,
     SHCMD("st -e pulsemixer; kill -44 $(pidof dwmblocks)")},
    {MODKEY | ShiftMask, XK_F4, spawn, SHCMD("fcmd.sh az minimal")},
