...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask, XK_F1,          spawn,      SHCMD("fcmd.sh set ls_Arbeitszimmer scene Arbeiten") },
    { MODKEY,           XK_F2,          spawn,      SHCMD("dmenuunicode") },
    { MODKEY|ShiftMask, XK_F2,          spawn,      SHCMD("fcmd.sh set ls_Arbeitszimmer scene Spielen") },
    { MODKEY,           XK_F3,          spawn,      SHCMD("st -e displayselect.sh") },
    { MODKEY|ShiftMask, XK_F3,          spawn,      SHCMD("fcmd.sh set ls_Arbeitszimmer scene ein") },
    { MODKEY,           XK_F4,          spawn,      SHCMD("st -e pulsemixer; kill -44 $(pidof dwmblocks)") },
    { MODKEY|ShiftMask, XK_F4,          spawn,      SHCMD("fcmd.sh set ls_Arbeitszimmer scene powersave") },
