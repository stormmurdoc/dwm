...
static Key keys[] = {
    ...
    {MODKEY, XK_F1, spawn,
     SHCMD("pamixer -t; kill -44 $(pidof dwmblocks) && pa_notify.sh")},
    {MODKEY | ShiftMask, XK_F1, spawn, SHCMD("ha-cli scene scene.arbeiten")},
    {MODKEY, XK_F2, spawn, SHCMD("dmenuunicode")},
    {MODKEY | ShiftMask, XK_F2, spawn, SHCMD("ha-cli scene scene.arbeitszimmer_spielen")},
    {MODKEY, XK_F3, spawn, SHCMD("st -e displayselect.sh")},
    {MODKEY | ShiftMask, XK_F3, spawn, SHCMD("ha-cli scene scene.arbeitszimmer_hell")},
    {MODKEY, XK_F4, spawn,
     SHCMD("st -e pulsemixer; kill -44 $(pidof dwmblocks)")},
    {MODKEY | ShiftMask, XK_F4, spawn, SHCMD("ha-cli scene scene.arbeitszimmer_minimal")},
    {MODKEY, XK_F5, xrdb, {.v = NULL}},
    {MODKEY | ShiftMask, XK_F5, spawn, SHCMD("fcmd.sh az powersave")},
