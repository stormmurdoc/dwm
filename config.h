...
static char *fonts[] = {
    ...
    "monospace:size=9", "JoyPixels:pixelsize=9:antialias=true:autohint=true"};
static char normbgcolor[] = "#020222";
static char normbordercolor[] = "#020222";
...
const char *spcmd1[] = {TERMINAL, "-n", "spterm",      "-g",
                        "120x34", "-e", "tmuxinit.sh", NULL};
...
static const char *tags[] = {
    "1:Web ",   "2:Term ", "3:Files ", "4:k3s ", "5:IRC ",
    "6:Email ", "7:Music 🎹", "8",           "9"};
...
static const Rule rules[] = {
     ...
     * print}/^WM_NAME/{sub(/.* =/, "title:"); print}' WM_CLASS(STRING) =
     * instance, class WM_NAME(STRING) = title
     */
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_l, spawn,
     SHCMD("betterlockscreen -l '/home/murdoc/ownCloud/Bilder "
           "(Kopie)/Hintergrundbilder/trevor-cole-393228.jpg'")},
    ...
    {MODKEY | ShiftMask, XK_s, spawn,
     SHCMD(
         "ha-cli device toggle switch.eg_wz_sofa_steckdose_sofa_steckdose_2")},
    ...
    {MODKEY, XK_n, spawn,
     SHCMD("st -e nvim -u /home/murdoc/.config/nvim/init.lua -c VimwikiIndex")},
    {MODKEY | ShiftMask, XK_n, spawn,
     SHCMD("st -e newsboat; pkill -RTMIN+6 dwmblocks")},
    {MODKEY, XK_m, spawn, SHCMD("st -e ncmpcpp")},
    {MODKEY | ShiftMask, XK_m, spawn,
     SHCMD("pamixer -t; kill -44 $(pidof dwmblocks) && pa_notify.sh")},
    ...
    {MODKEY, XK_Insert, spawn,
     SHCMD("notify-send \"📋 Clipboard contents:\" \"$(xclip -o -selection "
           "clipboard)\"")},
    {MODKEY, XK_F1, spawn,
     SHCMD("pamixer -t; kill -44 $(pidof dwmblocks) && pa_notify.sh")},
    {MODKEY | ShiftMask, XK_F1, spawn,
     SHCMD("ha-cli scene scene.arbeitszimmer_arbeiten")},
    {MODKEY, XK_F2, spawn, SHCMD("dmenuunicode")},
    {MODKEY | ShiftMask, XK_F2, spawn,
     SHCMD("ha-cli scene scene.arbeitszimmer_spielen")},
    {MODKEY, XK_F3, spawn, SHCMD("st -e displayselect.sh")},
    {MODKEY | ShiftMask, XK_F3, spawn,
     SHCMD("ha-cli scene scene.arbeitszimmer_hell")},
    {MODKEY, XK_F4, spawn,
     SHCMD("st -e pulsemixer; kill -44 $(pidof dwmblocks)")},
    {MODKEY | ShiftMask, XK_F4, spawn,
     SHCMD("ha-cli scene scene.arbeitszimmer_minimal")},
    {MODKEY, XK_F5, xrdb, {.v = NULL}},
    {MODKEY | ShiftMask, XK_F5, spawn,
     SHCMD("ha-cli scene scene.arbeitszimmer_aus")},
    ...
    {0, XF86XK_MonBrightnessUp, spawn,
     SHCMD("xbacklight -inc 15 && xbl_notify.sh")},
    {0, XF86XK_MonBrightnessDown, spawn,
     SHCMD("xbacklight -dec 15 && xbl_notify.sh")},
};
